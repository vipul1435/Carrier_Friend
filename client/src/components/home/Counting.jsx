...
const Counting = () => {
  ...
  return (
    <Box sx={{display:"flex",justifyContent:'center', [theme.breakpoints.up('md')]:{flexDirection:"row"}, [theme.breakpoints.down('md')]:{flexDirection:"column"}, alignItems:'center',px:'200px',my:"50px"}}>
          <Box sx={{display:"flex",justifyContent:'center',flexDirection:"column" , alignItems:'center',mx:'10px', }}>
            ...
            <Typography sx={{color:'grey',fontWeight:'300',textAlign:'center',px:"30px"}}>Full Time, Part Time and Internships avilable in variuos fields.</Typography>
          </Box>
          <Box sx={{display:"flex",justifyContent:'center',flexDirection:'column',  alignItems:'center',mx:'10px'}}>
            <Typography sx={{fontFamily:"Chakra Petch",fontSize:"50px",color:theme.palette.primary.main}}>{value}+</Typography>
            <Typography sx={{fontSize:'20px',fontWeight:'bold',fontFamily:"sans-serif",color:theme.palette.secondary.main}}>Opportunities</Typography>
